...
module.exports = {
  ...
  'core-list': {
    name: 'iron-list',
    notice: 'iron-list databinding has changed to be more like dom-repeat. ' +
            'The bindings here are probably broken, but can likely be fixed ' +
            'by adding the attribute `as="model"` onto iron-list. ' +
            'In addition, iron-list no longer tracks selection.'
  },
  'core-localstorage': {
  ...
  'core-tooltip': {
    name: 'paper-tooltip',
    notice: 'Whereas core-tooltip was intended to contain the element it ' +
            'decorated, paper-tooltip decorates its parent, or with the ' +
            '`for` attribute, its sibling. TODO(polyup): move the tooltip\'s ' +
            'label into the body of the <paper-tooltip>, and the decorated ' +
            'element out.',
    deprecatedAttributes: [
        'label', 'show', 'position', 'noarrow', 'tipAttribute']
  },
  'core-transition': {
  ...
  'paper-dropdown': {
    ...
    notice: 'May need to add a paper-material wrapper to replicate the ' +
            'paper-dropdown look and feel, depending on whether another ' +
            'element like paper-menu-button is wrapping this one.'
  },
  'paper-dropdown-menu': {
    // nothing to do
  },
  ...
  animationMappings: {
    'cascade-transition': 'cascaded-animation',
    'list-cascade': 'cascaded-animation',
    'tile-cascade': 'cascaded-animation',
    'hero-transition': 'hero-animation',
    'cross-fade': 'fade-in-animation',
    'scale-up': 'scale-up-animation',
    'slide-down': 'slide-down-animation',
    'slide-from-bottom': 'slide-up-animation',
